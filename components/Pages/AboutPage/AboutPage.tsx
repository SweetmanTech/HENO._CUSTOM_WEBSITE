...
const AboutPage = () => (
  <Layout type="base">
    <div className="p-[10px] border-[2px] border-[#d2d2d2] h-full">
      <div
        className="border-[2px] border-[#8c8c8c] text-[#d2d2d2] font-dresden p-[20px] text-center
                flex flex-col gap-y-[10px] items-center justify-center text-[16px] h-full relative"
      >
        <p>
